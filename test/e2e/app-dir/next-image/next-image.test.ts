    ...
    it('should render images on / route', async () => {
      ...
      if (process.env.IS_TURBOPACK_TEST) {
        expect(layout.attr('src')).toMatchInlineSnapshot(
          `"/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.9f12c820.png&w=828&q=85"`
        )
      } else {
        expect(layout.attr('src')).toMatchInlineSnapshot(
      ...
      if (process.env.IS_TURBOPACK_TEST) {
        expect(layout.attr('srcset')).toMatchInlineSnapshot(
          `"/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.9f12c820.png&w=640&q=85 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.9f12c820.png&w=828&q=85 2x"`
        )
      } else {
        expect(layout.attr('srcset')).toMatchInlineSnapshot(
      ...
      if (process.env.IS_TURBOPACK_TEST) {
        expect(page.attr('src')).toMatchInlineSnapshot(
          `"/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.9f12c820.png&w=828&q=90"`
        )
      } else {
        expect(page.attr('src')).toMatchInlineSnapshot(
      ...
      if (process.env.IS_TURBOPACK_TEST) {
        expect(page.attr('srcset')).toMatchInlineSnapshot(
          `"/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.9f12c820.png&w=640&q=90 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.9f12c820.png&w=828&q=90 2x"`
        )
      } else {
        expect(page.attr('srcset')).toMatchInlineSnapshot(
      ...
      if (process.env.IS_TURBOPACK_TEST) {
        expect(comp.attr('src')).toMatchInlineSnapshot(
          `"/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.9f12c820.png&w=828&q=80"`
        )
      } else {
        expect(comp.attr('src')).toMatchInlineSnapshot(
      ...
      if (process.env.IS_TURBOPACK_TEST) {
        expect(comp.attr('srcset')).toMatchInlineSnapshot(
          `"/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.9f12c820.png&w=640&q=80 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Ftest.9f12c820.png&w=828&q=80 2x"`
        )
      } else {
        expect(comp.attr('srcset')).toMatchInlineSnapshot(
